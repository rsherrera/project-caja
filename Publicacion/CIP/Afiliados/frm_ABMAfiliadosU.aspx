 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_ABMAfiliadosU.aspx.cs" Inherits="CIP.frm_ABMAfiliadosU" %>
...
//         }
         ...
         function validaDebitoA() {

            // alert(document.getElementById('txtOhastaA').value);
             if (document.getElementById('txtOhastaA').value != '') {
                 if (validafecha('txtOhastaA') == false) {
                     document.getElementById('hdf_fechaActual').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechaActual').value = "T";
             }
             else document.getElementById('hdf_fechaActual').value = "T";
         ...
         function validaDebitoV() {

            
           //  alert(document.getElementById('txtOhastaV').value);
             if (document.getElementById('txtOhastaV').value != '') {
                 if (validafecha('txtOhastaV') == false) {
                     document.getElementById('hdf_fechaAtrasado').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechaAtrasado').value = "T";
             }
             else document.getElementById('hdf_fechaAtrasado').value = "T";
         ...
         function validaDebitoP() {
           alert(document.getElementById('txtOhastaP').value);
             if (document.getElementById('txtOhastaP').value != '') {
                 if (validafecha('txtOhastaP') == false) {
                     document.getElementById('hdf_fechapres').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechapres').value = "T";
             }
             else document.getElementById('hdf_fechapres').value = "T";
         ...
         function validaDebitoJ() {

             

             alert(document.getElementById('txtOhastaJ').value);
             if (document.getElementById('txtOhastaJ').value != '') {
                 if (validafecha('txtOhastaJ') == false) {
                     document.getElementById('hdf_fechajudi').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechajudi').value = "T";
             }
             else document.getElementById('hdf_fechajudi').value = "T";
         ...
         function validaDebitoG() {
             alert(document.getElementById('txtOhastaG').value);
             if (document.getElementById('txtOhastaG').value != '') {
                 if (validafecha('txtOhastaG') == false) {
                     document.getElementById('hdf_fechaGasto').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechaGasto').value = "T";
             }
             else document.getElementById('hdf_fechaGasto').value = "T";
         ...
         function validacategoria() {
             //alert(document.getElementById('txtOfechatitulo').value);
             if (document.getElementById('txtOfechatitulo').value != '') {
                 if (validafecha('txtOfechatitulo') == false) {
                     document.getElementById('hdf_fechatitu').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechatitu').value = "T";
             }
             else document.getElementById('hdf_fechatitu').value = "T";
         ...
         function validar() {
        // alert('e');
         //    alert(document.getElementById('txtOfechaalta').value);
             if (document.getElementById('txtOfechaalta').value != '') {
                 if (validafecha('txtOfechaalta') == false) {
                     document.getElementById('hdf_fechaalta').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechaalta').value = "T";
             }
             else document.getElementById('hdf_fechaalta').value = "T";

             //alert(document.getElementById('txtOfechadictamen').value);
           
             if (document.getElementById('txtOfechadictamen').value != '') {
                 if (validafecha('txtOfechadictamen') == false) {
                     document.getElementById('hdf_fechadicta').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechadicta').value = "T";
             }
             else document.getElementById('hdf_fechadicta').value = "T";
             
 // alert(document.getElementById('txtOSolicitud').value);
  
             if (document.getElementById('txtOSolicitud').value != '') {
                 if (validafecha('txtOSolicitud') == false) {
                     document.getElementById('hdf_fechasoli').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechasoli').value = "T";
             }
             else document.getElementById('hdf_fechasoli').value = "T";
           //   alert(document.getElementById('txtOfechatitulo').value);
           ...
           //   alert(document.getElementById('txtOfechamatricula').value);
  
             if (document.getElementById('txtOfechamatricula').value != '') {
                 if (validafecha('txtOfechamatricula') == false) {
                     document.getElementById('hdf_fechamat').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechamat').value = "T";
             }
             else document.getElementById('hdf_fechamat').value = "T";
           ///   alert(document.getElementById('txt_fechavigente').value);
  
             if (document.getElementById('txt_fechavigente').value != '') {
                 if (validafecha('txt_fechavigente') == false) {
                     document.getElementById('hdf_fechavig').value = "F";
                     return false;
                 }
                 else document.getElementById('hdf_fechavig').value = "T";
             }
             else document.getElementById('hdf_fechavig').value = "T";

             //   alert(document.getElementById('txt_fechanac').value);
  
               if (document.getElementById('txt_fechanac').value != '') {
                   if (formatofecha('txt_fechanac') == false) {
                     document.getElementById('hdf_fechanac').value = "F";
                     return false;
                     }
                     else document.getElementById('hdf_fechanac').value = "T";
                 }
                 else document.getElementById('hdf_fechanac').value = "T";
...
<body>
    ...
    <form id="form2" runat="server"> 
          ...
          runat="server" />
                                  <asp:HiddenField ID="hdf_fechanac" Value="" 
          runat="server" /> <asp:HiddenField ID="hdf_fechaalta" Value="" 
          runat="server" /><asp:HiddenField ID="hdf_fechamat" Value="" 
          runat="server" /><asp:HiddenField ID="hdf_fechasoli" Value="" 
          runat="server" /><asp:HiddenField ID="hdf_fechadicta" Value="" 
          runat="server" /><asp:HiddenField ID="hdf_fechatitu" Value="" 
          runat="server" /><asp:HiddenField ID="hdf_fechavig" Value="" 
          runat="server" />
          <asp:HiddenField ID="hdf_fechaActual" Value="" 
          runat="server" />
          <asp:HiddenField ID="hdf_fechaAtrasado" Value="" 
          runat="server" />
          <asp:HiddenField ID="hdf_fechapres" Value="" 
          runat="server" />
          <asp:HiddenField ID="hdf_fechajudi" Value="" 
          runat="server" />
          <asp:HiddenField ID="hdf_fechaGasto" Value="" 
          runat="server" />
                         ...
                         <asp:MenuItem NavigateUrl="~/About.aspx" Text="Salir"/>
                                    ...
                                    <table style=" height: 140px; width: 1200px; margin-top:-30px">
                                        <tr>
                                            ...
                                            <td >
                                            <fieldset class="login" style="  height: 210px; width: 1262px;">
                      ...
                      <table >
                                                                <tr>
                                                                    <td class="style22" style="text-align:left">
                                                                        ...
                                                                        <asp:TextBox ID="txt_Afiliado" runat="server" MaxLength="80" Width="80px" Enabled="false"></asp:TextBox>
                                                                    </td>
                                                                    <td class="style22"style="text-align:left">
                                                                ...
                                                                <tr>
                                                                    <td class="style22"style="text-align:left">
                                                                        ...
                                                                        <asp:TextBox ID="txt_Apellido" runat="server"  MaxLength="50" 
                                                                    ...
                                                                    <td class="style22"style="text-align:left" >
                                                                        ...
                                                                        <asp:TextBox ID="txt_Nom" runat="server" MaxLength="50" 
                                                                            onkeypress="javascript:this.value=this.value.toUpperCase();" Width="155px" 
                                                                ...
                                                                <tr>
                                                                    <td class="style22" style="text-align:left">
                                                                        ...
                                                                        <asp:Label ID="msjnac" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                ...
                                                                <tr>
                                                                    <td class="style22" style="text-align:left">
                                                                        ...
                                                                        <asp:DropDownList ID="ddlODocu" runat="server" Width="140px">
                                                                         <asp:ListItem Value="1">LE</asp:ListItem>
                                                                            <asp:ListItem Value="2">LC</asp:ListItem>
                                                                             <asp:ListItem Value="3" >CEX</asp:ListItem>
                                                                            <asp:ListItem Value="4" Selected="True">DNI</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td class="style22" >
                                                            ...
                                                            <table style="width: 200px">
                                                                <tr>
                                                                    <td style="text-align:left">
                                                                        ...
                                                                        <asp:TextBox ID="txt_telefono" runat="server" MaxLength="50" onkeypress="javascript:return solonumeros(event)" Width="80px"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align:left">
                                                                        <asp:Label ID="Label29" runat="server" CssClass="Titulolabel" Text="Email:"></asp:Label>
                                                                        <asp:TextBox ID="txt_email" runat="server" MaxLength="50"  Width="150px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" style="text-align: left">
                                                                        <asp:Label ID="Label26" runat="server" CssClass="Titulolabel" Text="Domicilio:"></asp:Label>
                                                                        <asp:TextBox ID="txt_domicilio" runat="server" MaxLength="50" Width="350px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="text-align:left">
                                                                        <asp:Label ID="Label27" runat="server" CssClass="Titulolabel" Text="Localidad:"></asp:Label>
                                                                        <asp:TextBox ID="txt_Localidad" runat="server" MaxLength="50"  Width="150px"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align:left">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <asp:TextBox ID="txt_Nacionalidad" runat="server"  MaxLength="50" Width="150px"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align:left">
                                                                        <asp:Label ID="Label32" runat="server" CssClass="Titulolabel" Text="CP:"></asp:Label>
                                                                        <asp:TextBox ID="txt_cp" runat="server" MaxLength="15" Width="100px"  onkeypress="javascript:return solonumeros(event)"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                            ...
                                                            <table style="width: 380px"  >
                                                                <tr>
                                                                    <td >
                                                                        ...
                                                                        <asp:Label ID="msjmatri" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        <asp:Label ID="msjfa" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        <asp:DropDownList ID="ddl_banco" runat="server" Width="150px">
                                                                            <asp:ListItem Selected="True" Value="1">Superville</asp:ListItem>
                                                                            <asp:ListItem Value="2">San Juan</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label39" runat="server" CssClass="Titulolabel" Text="CUIT:"></asp:Label>
                                                                        <asp:TextBox ID="TXT_CUIT" runat="server" MaxLength="20" Width="100px" onkeypress="javascript:return solonumeroscuit(event)"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:Label ID="msjfso" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:Label ID="msjdi" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                    </td>
                                                                    <td colspan="2">
                                                                        <asp:Label ID="Label38" runat="server" CssClass="Titulolabel" Text="*Sello:"></asp:Label>
                                                                        <asp:TextBox ID="txtOsello" runat="server" MaxLength="20" Width="100px"  onkeypress="javascript:return solonumeros(event)"></asp:TextBox>
                                                                        <asp:TextBox ID="txtOsello1" runat="server" MaxLength="20" Width="50px"  onkeypress="javascript:return solonumeros(event)"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td >
                                                                        ...
                                                                        <asp:Label ID="msjti" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                    </td>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <asp:RadioButtonList ID="rbl_nivel" runat="server" Font-Bold="True" 
                                                                            ...
                                                                            <asp:ListItem Value="3">Cat3</asp:ListItem>
                                                                            <asp:ListItem Value="4">Cat4</asp:ListItem>
                                                                        </asp:RadioButtonList>
                                                                    </td>
                                                                    <td>
                                    ...
                                    <table style=" height: 140px; width: 1200px; margin-top:-70px">
          <tr>                                     
                                            <td >                                            
                                                <table style=" height: 317px; width: 1389px; margin-top: 0px;">
                                                    <tr>
                                                        <td >
                                                         <fieldset class="login" style="  height: 190px; width: 1262px;">
                    <legend>Débito</legend>
                                                            <table style="width: 878px; height: 118px;">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        &nbsp;</td>
                                                                    <td colspan="2">
                                                                        <asp:Label ID="msjvi" runat="server" CssClass="Msj" Text=""></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="style32">
                                                                          <asp:ImageButton ID="btnDDJ" runat="server" src="../Imagenes/edit_add.png"  Visible="false" OnClick="btnDDJOpen_Click"/>
                                                                         <asp:ImageButton ID="btnDAJ" runat="server" src="../Imagenes/edit_add.png" Visible="false" OnClick="btnDAJOpen_Click"/>
                                                                         <asp:ImageButton ID="btnTCJ" runat="server" src="../Imagenes/edit_add.png" Visible="false" OnClick="btnDCJOpen_Click"/>
                                                   ...
                                                   </table><table style=" height: 140px; width: 1200px; margin-top:-50px">
                                                    <tr>
                                                        <td >
       ...
       <asp:Panel ID="pnlDDAA" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                 ...
                                                                 <asp:Label ID="Label13" runat="server" Text="Banco para Débito Directo aporte actual" />
       ...
       <asp:Panel ID="pnlDDAV" runat="server" CssClass="CajaDialogo"   Style="display: none;" Height="241px" Width="542px">
                  <div>
                   <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="3">
                                                                 <asp:Label ID="Label30" runat="server" Text="VBanco para Débito Directo atrasad" />
       ...
       <asp:Panel ID="pnlDDP" runat="server" CssClass="CajaDialogo"     Style="display: none;" Height="241px" Width="542px">
            ...
            <div>
                      ...
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="3">
                                                                 <asp:Label ID="Label49" runat="server" Text="PBanco para Débito Directo pres" />
       ...
       <asp:Panel ID="pnlDDJ" runat="server" CssClass="CajaDialogo" Style="display: none;" Height="241px" Width="542px">
         <div>
              <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="3">
                                                                 <asp:Label ID="Label52" runat="server" Text="JBanco para Débito Directo ju" />
       ...
       <asp:Panel ID="pnlDDG" runat="server" CssClass="CajaDialogo" Style="display: none;" Height="241px" Width="542px">
         <div>
              <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="3">
                                                                 <asp:Label ID="Label107" runat="server" Text="Banco para Débito Directo gas" />
       ...
       <asp:Panel ID="pnlDAA" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                 ...
                                                                 <asp:Label ID="Label60" runat="server" Text="Banco para Débito Automático act" />
                                                                 ...
                                                                 <asp:Label ID="Label63" runat="server"  />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left" colspan="3">
                                                                            <asp:TextBox ID="txtOBcoDAA" runat="server" Width="150px" Enabled="false">SAN JUAN</asp:TextBox>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:RadioButtonList ID="RDB_TIPODAA" runat="server" Font-Bold="False" 
                                                                                ...
                                                                                <asp:ListItem Value="0">CA</asp:ListItem>
                                                                            </asp:RadioButtonList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
       ...
       <asp:Panel ID="pnl_DAV" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label68" runat="server" Text="Banco para Débito Automático vie" />
                                                                 ...
                                                                 <asp:Label ID="Label69" runat="server"  />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left" colspan="3">
                                                                            <asp:TextBox ID="txtOBcoDAV" runat="server" Width="150px" Enabled="false">SAN JUAN</asp:TextBox>
       ...
       <asp:Panel ID="pnl_DAP" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label71" runat="server" Text="Banco para Débito Automático prest" />
                                                                 ...
                                                                 <asp:Label ID="Label73" runat="server"  />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left" colspan="3">
                                                                            <asp:TextBox ID="txtOBcoDAP" runat="server" Width="150px" Enabled="false">SAN JUAN</asp:TextBox>
       ...
       <asp:Panel ID="pnl_DAJ" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label77" runat="server" Text="Banco para Débito Automático ju" />
                                                                 ...
                                                                 <asp:Label ID="Label79" runat="server"  />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left" colspan="3">
                                                                            <asp:TextBox ID="txtOBcoDAJ" runat="server" Width="150px" Enabled="false">SAN JUAN</asp:TextBox>
       ...
       <asp:Panel ID="pnl_DAG" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label110" runat="server" Text="Banco para Débito Automático ga" />
                                                                 ...
                                                                 <asp:Label ID="Label112" runat="server"  />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left" colspan="3">
                                                                            <asp:TextBox ID="txtOBcoDAG" runat="server" Width="150px" Enabled="false">SAN JUAN</asp:TextBox>
       ...
       <asp:Panel ID="pnl_CA" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label83" runat="server" Text="Banco para Débito Banco Comafi act" />
       ...
       <asp:Panel ID="pnl_CV" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label88" runat="server" Text="Banco para Débito Banco Comafi vie" />
       ...
       <asp:Panel ID="pnl_CP" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label93" runat="server" Text="Banco para Débito Banco Comafi pre" />
       ...
       <asp:Panel ID="pnl_CJ" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label101" runat="server" Text="Banco para Débito Banco Comafi ju" />
       ...
       <asp:Panel ID="pnl_CG" runat="server" CssClass="CajaDialogo" Style="display:none ;" Height="241px" Width="542px">
            ...
            <div>
                      <table style="border: thin solid #000000; width: 540px; background-color: #999999; height: 239px;">
                                                                    ...
                                                                    <td style="padding: 3px; background-color: #0033CC; color: #FFFFFF;" colspan="5">
                                                                 <asp:Label ID="Label117" runat="server" Text="Banco para Débito Banco Comafi gast" />
