<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_DebitoComafi.aspx.cs" Inherits="CIP.frm_DebitoComafi" %>
                                                ...
                                                <table style="border: thin groove #FFFFFF; width: 40%; height: 148px;">
                                                     <tr>
                                                        ...
                                                        <td style="border: thin solid #000000" >
                                                             <asp:Label ID="Label2" runat="server" CssClass="TituloForm" Text="Banco para Débito Banco Comafi"></asp:Label>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="style29">
                                                                ...
                                                                <table style="width: 780px">
                                                                    <tr>
                                                                        <td class="style31">
                                                                            <asp:Label ID="Label38" runat="server" CssClass="Titulolabel" Text="*Nro Tarjeta:"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtOnrotarjeta" runat="server" Width="180px"></asp:TextBox>
                                                                           
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="Label45" runat="server" CssClass="Titulolabel" Text="*Visa:"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlOVisa" runat="server" Width="158px">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtOhasta" runat="server" MaxLength="10" Width="80px"></asp:TextBox>
                                                                            <asp:MaskedEditExtender ID="txtOhasta_MaskedEditExtender" runat="server" 
                                                                                Mask="99/99/9999" MaskType="Date" TargetControlID="txtOhasta">
