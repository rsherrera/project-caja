<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_Debitoautomatico.aspx.cs" Inherits="CIP.frm_Debitoautomatico" %>
                                                ...
                                                <table style="border: thin groove #FFFFFF; width: 40%; height: 148px;">
                                                    <tr>
                                                        ...
                                                        <td style="border: thin solid #000000"  >
                                                             <asp:Label ID="Label2" runat="server" CssClass="TituloForm" Text="Banco para Débito Automático"></asp:Label>
                                                        ...
                                                        <td class="style29">
                                                                ...
                                                                <table style="width: 451px">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2">
                                                                            <asp:TextBox ID="txtOnro" runat="server"  Width="150px"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="style35">
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtOnrosucursal" runat="server" Width="80px"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            
                                                                            <asp:Label ID="Label40" runat="server" CssClass="Titulolabel" 
                                                                                Text="*Tipo:"></asp:Label><asp:RadioButtonList ID="RDB_TIPO" runat="server" 
                                                                                style="width: 42px" RepeatDirection="Horizontal" Font-Bold="False" 
                                                                                ForeColor="Black">
